...
--
-- Table structure for table `reward_conditions`
--

DROP TABLE IF EXISTS `reward_conditions`;
...
--
-- Dumping data for table `reward_conditions`
--

LOCK TABLES `reward_conditions` WRITE;
/*!40000 ALTER TABLE `reward_conditions` DISABLE KEYS */;
/*!40000 ALTER TABLE `reward_conditions` ENABLE KEYS */;
UNLOCK TABLES;
