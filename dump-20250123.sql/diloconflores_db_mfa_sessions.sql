...
CREATE TABLE `mfa_sessions` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `mfa_sessions_ibfk_1` FOREIGN KEY (`session_id`) REFERENCES `sessions` (`id`) ON DELETE CASCADE,
  CONSTRAINT `mfa_sessions_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
