...
--
-- Table structure for table `card_sizes`
--
...
--
-- Dumping data for table `card_sizes`
--

LOCK TABLES `card_sizes` WRITE;
/*!40000 ALTER TABLE `card_sizes` DISABLE KEYS */;
/*!40000 ALTER TABLE `card_sizes` ENABLE KEYS */;
UNLOCK TABLES;
