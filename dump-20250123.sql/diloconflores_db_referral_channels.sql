...
--
-- Table structure for table `referral_channels`
--

DROP TABLE IF EXISTS `referral_channels`;
...
--
-- Dumping data for table `referral_channels`
--

LOCK TABLES `referral_channels` WRITE;
/*!40000 ALTER TABLE `referral_channels` DISABLE KEYS */;
/*!40000 ALTER TABLE `referral_channels` ENABLE KEYS */;
UNLOCK TABLES;
