...
CREATE TABLE `branches` (
  ...
  `comments` text,
  `storefront` tinyint(1) DEFAULT '0',
  `allows_pickup` tinyint(1) DEFAULT '0',
  ...
  KEY `city_id` (`city_id`),
  CONSTRAINT `branches_ibfk_1` FOREIGN KEY (`address_type_id`) REFERENCES `address_types` (`id`),
  CONSTRAINT `branches_ibfk_2` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`),
  CONSTRAINT `branches_ibfk_3` FOREIGN KEY (`state_id`) REFERENCES `states` (`id`),
  CONSTRAINT `branches_ibfk_4` FOREIGN KEY (`city_id`) REFERENCES `cities` (`id`)
