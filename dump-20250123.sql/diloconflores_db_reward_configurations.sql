...
CREATE TABLE `reward_configurations` (
  ...
  CONSTRAINT `reward_configurations_ibfk_1` FOREIGN KEY (`reward_type_id`) REFERENCES `reward_types` (`id`)
...
LOCK TABLES `reward_configurations` WRITE;
/*!40000 ALTER TABLE `reward_configurations` DISABLE KEYS */;
/*!40000 ALTER TABLE `reward_configurations` ENABLE KEYS */;
UNLOCK TABLES;
