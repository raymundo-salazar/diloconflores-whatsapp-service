...
CREATE TABLE `media` (
  ...
  KEY `media_service_id` (`media_service_id`),
  KEY `media_type_id` (`media_type_id`),
  CONSTRAINT `media_ibfk_1` FOREIGN KEY (`media_service_id`) REFERENCES `media_services` (`id`) ON DELETE CASCADE,
