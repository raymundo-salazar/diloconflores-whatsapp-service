...
CREATE TABLE `delivery_timeslots` (
  ...
  `applies_to` enum('global','branch') NOT NULL,
...
LOCK TABLES `delivery_timeslots` WRITE;
/*!40000 ALTER TABLE `delivery_timeslots` DISABLE KEYS */;
/*!40000 ALTER TABLE `delivery_timeslots` ENABLE KEYS */;
UNLOCK TABLES;
