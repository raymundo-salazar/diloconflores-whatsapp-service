...
CREATE TABLE `order_cards` (
  ...
  CONSTRAINT `order_cards_ibfk_1` FOREIGN KEY (`order_product_id`) REFERENCES `order_products` (`id`) ON DELETE CASCADE,
  CONSTRAINT `order_cards_ibfk_2` FOREIGN KEY (`template_id`) REFERENCES `card_templates` (`id`) ON DELETE CASCADE
