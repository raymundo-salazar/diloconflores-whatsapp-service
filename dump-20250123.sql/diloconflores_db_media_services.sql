...
--
-- Table structure for table `media_services`
--
...
--
-- Dumping data for table `media_services`
--

LOCK TABLES `media_services` WRITE;
/*!40000 ALTER TABLE `media_services` DISABLE KEYS */;
/*!40000 ALTER TABLE `media_services` ENABLE KEYS */;
UNLOCK TABLES;
